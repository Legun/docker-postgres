[![Circle CI](https://circleci.com/gh/threew82/docker-postgresql.svg?style=shield)](https://circleci.com/gh/threew82/docker-postgresql) [![Docker Repository on Quay.io](https://quay.io/repository/threew82/postgresql/status "Docker Repository on Quay.io")](https://quay.io/repository/threew82/postgresql) [![](https://badge.imagelayers.io/threew82/postgresql.svg)](https://imagelayers.io/?images=threew82/postgresql:latest 'Get your own badge on imagelayers.io')

# threew82/postgresql:9.6
...
Automated builds of the image are available on [Dockerhub](https://hub.docker.com/r/threew82/postgresql) and is the recommended method of installation.

> **Note**: Builds are also available on [Quay.io](https://quay.io/repository/threew82/postgresql)

```bash
docker pull threew82/postgresql:9.6-2
```

Alternatively you can build the image yourself.

```bash
docker build -t threew82/postgresql github.com/threew82/docker-postgresql
```
...
```bash
docker run --name postgresql -itd --restart always \
  threew82/postgresql:9.6-2 -c log_connections=on
```
...
```bash
docker run --name postgresql -itd --restart always \
  threew82/postgresql:9.6-2 -c logging_collector=on
```
